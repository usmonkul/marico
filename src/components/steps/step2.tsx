    ...
    return (
        <section className='pb-32 md:pt-32 container flex flex-col items-center justify-center'>
            <div className="flex flex-col items-center md:mb-14 lg:mb-18">
                ...
                <p className="text-text-content md:text-2xl mt-5 lg:mt-1 mb-8 max-w-[640px] text-center text-pretty">
            ...
            <div className="flex flex-col lg:flex-row w-full mb-10 overflow-hidden gap-4">
                <div className="w-full lg:w-1/2 flex flex-col gap-3">
                    ...
                    <p className="text-4xl lg:text-7xl text-semibold mb-5"> <span className='text-text-content-darker'>All You Create.</span> <br /> One Link</p>
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-3 lg:gap-24 pl-2 mt-10 lg:mt-0">
                    ...
                    <p className="text-4xl lg:text-7xl text-semibold"> <span className='text-text-content-darker'>Emails. <br />Phone #s.</span> <br />All Yours</p>
                </div>
            </div>
